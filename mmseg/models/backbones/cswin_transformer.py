...
class CSWin(nn.Module):
    ...
    def __init__(self, img_size=[224, 224], patch_size=4, in_chans=3, embed_dim=64, depth=[1, 2, 21, 1], split_size=7,
        ...
        self.stage1 = nn.ModuleList([
            CSWinBlock(
                dim=curr_dim, num_heads=heads[0], patches_resolution=[img_size[0] // 4, img_size[1] // 4], mlp_ratio=mlp_ratio,
        ...
        self.stage2 = nn.ModuleList(
            [CSWinBlock(
                dim=curr_dim, num_heads=heads[1], patches_resolution=[img_size[0] // 8, img_size[1] // 8], mlp_ratio=mlp_ratio,
        ...
        temp_stage3.extend(
            [CSWinBlock(
                dim=curr_dim, num_heads=heads[2], patches_resolution=[img_size[0] // 16, img_size[1] // 16], mlp_ratio=mlp_ratio,
        ...
        self.stage4 = nn.ModuleList(
            [CSWinBlock(
                dim=curr_dim, num_heads=heads[3], patches_resolution=[img_size[0] // 32, img_size[1] // 32], mlp_ratio=mlp_ratio,
                qkv_bias=qkv_bias, qk_scale=qk_scale, split_size=split_size[-1],
                drop=drop_rate, attn_drop=attn_drop_rate,
